...
export const Register = () => {
    ...
    const existingUserCheck = () => {
        ...
        return fetch(`http://localhost:8000/users?email=${registerUser.email}`)
            .then(res => res.json())
                    ...
                    fetch("http://localhost:8000/users", {
                        ...
                        .then(createdUser => {
                            if (createdUser.hasOwnProperty("id")) {
                                ...
                                sessionStorage.setItem("midea_user", createdUser.id)
                                history.push("/")
                            }
                        })
                }
    ...
    return (
        <main style={{ textAlign: "center" }} className="register_page">
